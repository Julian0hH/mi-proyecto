...
class ServiciosAdminController extends BaseController
{
    ...
    public function crear(): ResponseInterface
    {
        try {
            ...
            return $this->response->setJSON(['success' => $ok, 'mensaje' => $ok ? 'Servicio creado correctamente' : 'Error al crear servicio']);
        } catch (\Throwable $e) {
    ...
    public function eliminar(int $id): ResponseInterface
    {
        ...
        return $this->response->setJSON(['success' => $ok, 'mensaje' => $ok ? 'Servicio eliminado' : 'Error al eliminar']);
    }
}
