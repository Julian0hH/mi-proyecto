...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="fw-bold mb-1">
            <i class="bi <?= esc($icono ?? 'bi-bar-chart-line-fill') ?> me-2 text-<?= esc($color ?? 'info') ?>"></i><?= esc($titulo ?? 'Reportes y Analítica') ?>
        </h2>
        <p class="text-muted small mb-0"><?= esc($subtitulo ?? 'KPIs, métricas de negocio e indicadores de rendimiento') ?></p>
    </div>
                ...
                <tbody>
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">
                            ...
                            <strong>Sin reportes generados</strong>
